...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]czzutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []czzutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []czzutil.Address,
