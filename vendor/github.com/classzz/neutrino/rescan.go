...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*czzutil.Block, error)
...
func WatchAddrs(watchAddrs ...czzutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *waddrmgr.BlockStamp) ([]*czzutil.Tx, error) {
	...
	relevantTxs := make([]*czzutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *czzutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *czzutil.Tx) (bool, error) {
...
func AddAddrs(addrs ...czzutil.Address) UpdateOption {
