...
function which allows a czzlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/classzz/classzz/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
