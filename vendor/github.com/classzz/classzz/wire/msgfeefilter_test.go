...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.CzzEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.CzzDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.CzzEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.CzzDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.CzzEncode(w, test.pver, BaseEncoding)
		...
		err = msg.CzzDecode(r, test.pver, BaseEncoding)
