...
func TestInvVectWire(t *testing.T) {
	...
	tests := []struct {
		...
		// Protocol version 0 error inventory vector.
		{
			errInvVect,
			errInvVect,
			errInvVectEncoded,
		...
		// Protocol version 0 tx inventory vector.
		{
			txInvVect,
			txInvVect,
			txInvVectEncoded,
		...
		// Protocol version 0 block inventory vector.
		{
			blockInvVect,
			blockInvVect,
			blockInvVectEncoded,
		...
		// Protocol version 0 cmpctblock inventory vector.
		{
			cmpctBlockInvVect,
			cmpctBlockInvVect,
			cmpctBlockInvVectEncoded,
