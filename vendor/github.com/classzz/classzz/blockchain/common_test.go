...
// czzutil.Block.  This is largely borrowed from the test code in czzdb.
func loadBlocks(filename string) (blocks []*czzutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = czzutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
