...
//
// Panics on errors.
func addBlock(chain *BlockChain, prev *czzutil.Block, spends []*spendableOut) (*czzutil.Block, []*spendableOut) {
	...
	block := czzutil.NewBlock(&wire.MsgBlock{
...
func TestUtxoCache_SimpleFlush(t *testing.T) {
	...
	tip := czzutil.NewBlock(params.GenesisBlock)
