...
func newBlockProgressLogger(progressMessage string, logger czzlog.Logger) *blockProgressLogger {
...
func (b *blockProgressLogger) LogBlockHeight(block *czzutil.Block, bestHeight uint64) {
	b.Lock()
	defer b.Unlock()
