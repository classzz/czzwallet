...
func storeFilter(dbTx database.Tx, block *czzutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *czzutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *czzutil.Block,
